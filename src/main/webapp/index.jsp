	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div id="navbar" class="collapse navbar-collapse">
			...
			<form action ="./index.jsp"  method = "get" class = "form-inline my-2 my-lg-0">
					<input type ="text" name = "search" class = "form-control mr-sm-2"  placeholder = "내용 입력하세요" >
			...
			<div class = "card-header bg-light">
				<div class ="row">
					...
					<div class = "col-4 text-right">
						 난이도 : <span style ="color: red;" class = "mx-1"><%= evaluation.getLectureDifficult()%></span>
					</div>
				</div>			
			</div>	
			<div class = "card-body">
				...
				<div class = "row">
						<div class = "col-9 text-left">
							강의 구분 : <span style ="color :red;"><%= evaluation.getLectureDivide() %></span>
							교수 강의력 : <span style ="color :red;"><%= evaluation.getLecturePower() %></span>
							과제 : <span style ="color :red;"><%= evaluation.getLectureAssignment() %></span>
							...
							<div class = "form-row">
								...
								<div class = "form-group col -sm -3">
									...
									<select name = "lectureAssignment" class = "form-control">
											<option value="적음" selected>적음</option>
