...
<%
	...
	if(request.getParameter("reportselect") != null) {
		reportselect = (String) request.getParameter("reportselect");
		}
	
	if (reportTitle == null || reportContent == null || reportselect == null) {
		PrintWriter script = response.getWriter();
		script.println("<script>");
